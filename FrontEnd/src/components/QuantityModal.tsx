...
const QuantityModal: React.FC<QuantityModalProps> = ({
  ...
  >
    ...
    <div className="flex flex-col gap-3 justify-center items-center w-[300px] p-5 bg-white rounded-md shadow-lg m-0">
      {/* Product Name */}
      ...
      {/* Confirm Button */}
      <button
        className="px-4 py-2 mt-3 rounded-full border border-black text-black text-sm bg-white hover:bg-gray-100"
        onClick={handleSave}
      >
        Confirm
      </button>
